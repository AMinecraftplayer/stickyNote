...
public class stickyNote {
	...
	// Constant
	public static final String MOD_ID = "stickynote";// Mod id which the mod is
														// identified with
														// against other mods.
														// Must be lowercase
	public static final String MOD_NAME = "Osky's Sticky Note's Mod";// The
																		// actual
																		// name
																		// of
																		// the
																		...
																		// to
																		// users
	public static final String VERSION = "@VERSION@";// The version number.
														// replace this string
														// with current build
														// number in
														// build.gradle
	public static final String DEPENDENCIES = ""; // Required-after: given mod
													// need to be loaded, my mod
													// loads after & after: my
													// mod loads after given mod
													// or before
	...
	@Instance(MOD_ID)
	public static stickyNote instance;// THe instance of the mod. Cuz u need a
										// instance.
	...
	@EventHandler
	public void postInit(FMLPostInitializationEvent event) {// Lastly mods
															// finishing goes
															// through post-init
	...
	public static CreativeTabs tabStickyNote = new CreativeTabs(
			stickyNote.RESOURCEPREFIX + "creative_tab") {
