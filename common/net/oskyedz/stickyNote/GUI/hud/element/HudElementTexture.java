...
public abstract class HudElementTexture extends HudElement {
	...
	/** ResourceLocation of the interface texture for the StickyNote */
	protected static final ResourceLocation INTERFACE = new ResourceLocation("stickyNote:textures/gui/interface.png");
