...
import net.oskyedz.stickyNote.settings.EnumOptionsDebugMod;
import net.oskyedz.stickyNote.settings.EnumOptionsDebugMod.EnumOptionsType;
import net.oskyedz.stickyNote.gui.hud.element.HudElementType;
import net.oskyedz.stickyNote.main.ModStickyNote;

public class GuiIngameStickyNote extends GuiIngameForge {
	 ...
	 */
	public GuiIngameStickyNote(Minecraft mc) {
		super(mc);
